...
BROWSER = {firefox: 'localhost'}#chrome: 'localhost',internet_explorer: '192.168.10.174'},internet_explorer: 'localhost',
threads=[]
...
BROWSER.each_pair do |browser, machine|
  threads << Thread.new do
    ...
    ob.open_ldap(server,Thread.current[:driver])
    ...
    recipient='User R<user_r@qa-server2.com>'
    ...
    member='user_rsrp@qa-server2.com'
    managed='user_rsa@qa-server2.com'
    shared='user_rsrpa@qa-server2.com'
    ...
    recipient='user_rs@qa-server2.com'
    cc='user_r@qa-server2.com'
    bcc='user_rsrp@qa-server2.com'
    ...
    manager='user_rs@qa-server2.com'
    collaborator='user_srp@qa-server2.com'
    viewer='user_r@qa-server2.com'
